...
package com.evildave
{
     ...
     * Two implementations:
     *
     * One depends on MovieClip.addFrameScript, which could 'disappear' someday (unlikely).
     *
    ...
    **/
    public class MCE extends Event
    {
        ...
        **/
        ...
        public function MCE(type:String, bubbles:Boolean = false, cancelable:Boolean = false)
        {
...
CONFIG::DIKEIN
{
        ...
        **/
        public static function Enable( mc : MovieClip ) : MovieClip
        {
            ...
            {
                mc.dispatchEvent( new clsMCE(clsMCE.FIRST) );
                if( null != mc.currentLabel )
                    mc.dispatchEvent( new clsMCE(clsMCE.LABEL_FIRST) );
            }
            ...
            {
                if( null != mc.currentLabel )
                    mc.dispatchEvent( new clsMCE(clsMCE.LABEL_LAST) );
                mc.dispatchEvent( new clsMCE(clsMCE.LAST) );
            }
...
CONFIG::DEBUG { debug.Assert( label is Number || label is String ); }
        ...
        **/
        ...
        {
            util.DObjBreadthFirst( dobj, Stop );
            function Stop(dobj:DisplayObject):Boolean
            {
        ...
        **/
        ...
        {
            util.DObjBreadthFirst( dobj, Start );
            function Start(dobj:DisplayObject):Boolean
            {
                if( dobj is MovieClip )
                {
